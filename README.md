...
[![Versão](https://img.shields.io/badge/versão-1.12.0-blue)](./CHANGELOG.md)
...
- **Estatística por pontos (zonal)** — informe pontos (`lat, lon` ou UTM `E, N`) e um raio (buffer circular) e o app amostra os pixels do raster carregado dentro de cada círculo, calculando **média, desvio-padrão, mín, máx e mediana por banda** (útil para NDVI/índices, DSM ou ortomosaico). Cor/estilo dos círculos configuráveis; exporta em **CSV** e **GeoJSON**.

...
[![Versão](https://img.shields.io/badge/versão-1.21.1-blue)](./CHANGELOG.md)
...
- **Recorte do ortomosaico** — marque a área de interesse (polígono ou retângulo, ou reaproveite a área do voo) e **recorte** o raster; passe a visualizar, calcular estatística e gerar índice **só na parte útil**, e salve o recorte (PNG + worldfile). **↺ Imagem inteira** restaura o original. Ao baixar — recorte ou imagem inteira — o arquivo sai **com o que estiver marcado no mapa** (buffers da estatística por pontos e a área desenhada); desmarque **«Incluir as marcações»** para levar o raster limpo ao QGIS.
